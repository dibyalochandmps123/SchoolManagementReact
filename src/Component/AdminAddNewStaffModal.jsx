...
// import {postAddNewStaff} from "../API/staffManagement"
export default function AdminAddNewStaffModal({
  ...
  const handleSubmit = () => {
    ...
    const payload = {
      id: AddNew.staffId,
      name: AddNew.fullName,
      email: AddNew.email,
      phone: AddNew.phoneNumber,
      department: AddNew.department,
      designation: AddNew.designation,
      gender: AddNew.gender,
      dob: AddNew.dateOfBirth,
      joinDate: AddNew.joinDate,
      qualification: AddNew.qualification,
      username: AddNew.loginId,
      password: AddNew.loginPassword,
      profile: AddNew.profile,
    };
    // postAddNewStaff(payload);
    handleAddNewStaff(payload);
    handleCloseAddNew();
  };
      ...
      <Modal.Body>
        <Form>
          ...
          <Row className="mb-3">
            ...
            {AddNew.designation !== "Sr. HR" && (
            <Col>
              <Form.Group>
                <Form.Label>Choose Reporting Officer</Form.Label>
                <Form.Select value="Report to">
