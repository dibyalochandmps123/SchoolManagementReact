...
import {putUpdateStaffData} from "../API/staffManagement"
export default function AdminEditStaffModal({ showEdit, handleCloseEdit, edit, handleUpdate }) {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      document: "", // set this if you handle documents separately
      username: editForm.loginId,
      password: editForm.loginPassword,
    };
    try {
      await putUpdateStaffData(payload);                 
