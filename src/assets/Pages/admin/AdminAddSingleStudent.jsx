    ...
    <Container fluid className="p-4 bg-light">
      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          <Row className="g-3">
            <Col md={4}>
              <Form.Select value={formData.admissionClass} onChange={handleChange("admissionClass")}>
            ...
            <Col md={4}>
              <Form.Control placeholder="Section" value={formData.section} onChange={handleChange("section")} />
            </Col>
            <Col md={4}>
